            ...
            >
              ...
              >
                <template v-for="child in item.children" :key="child.path">
                  <Collapsible v-if="child.children" :default-open="true" class="mt-2 first:mt-0">
                     <CollapsibleTrigger class="...">
                        {{ child.title }} <ChevronRight class="..." />
                     </CollapsibleTrigger>
                     <CollapsibleContent class="...">
                        <NuxtLink v-for="subchild in child.children" :key="subchild.path" :to="subchild.path" class="...">
                           {{ subchild.title }}
                        </NuxtLink>
                     </CollapsibleContent>
                  </Collapsible>
